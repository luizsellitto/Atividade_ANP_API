...
using Atividade_ANP_API.Repositories;

namespace Atividade_ANP_API.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        public IActionResult Criar([FromBody] ClienteDto clienteDto)
        {
            ...
            var cliente = ClienteRepository.Criar(clienteDto);
            return Ok(cliente);
        }
        ...
        public IActionResult Atualizar(int id, [FromBody] ClienteDto clienteAtualizado)
        {
            ...
            var cliente = ClienteRepository.Atualizar(id, clienteAtualizado);
            if (cliente == null)
            {
                return NotFound();
            }
        ...
        {
            var verificar = ClienteRepository.Deletar(id);
            if (!verificar)
            {
                return NotFound();
            }
